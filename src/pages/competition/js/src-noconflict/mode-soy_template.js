  ...
  function (require, exports, module) {
    ...
    var SoyTemplateHighlightRules = function () {
      ...
      var soyRules = {
        ...
        '#comment-line': [
          { token: ['comment.line.double-slash.soy', 'comment.line.double-slash.soy'], regex: '(//)(.*$)' },
        ],
        '#comment-block': [
          {
...
ace.define(
  ...
  ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/html', 'ace/mode/soy_template_highlight_rules'],
  function (require, exports, module) {
    'use strict';
    var oop = require('../lib/oop');
