        ...
        start: [
          ...
          },
          {
            token: function (value) {
              ...
              else if (keywords.hasOwnProperty(value) || reserved.hasOwnProperty(value)) return 'keyword';
              else if (buildinConstants.hasOwnProperty(value)) return 'constant.language';
              else if (/^_?[A-Z][a-zA-Z0-9_]*$/.test(value)) return 'language.support.class';
