  ...
  })(
    {
            ...
            (function (global, factory) {
              ...
              function deepEq(a, b, aStack, bStack) {
                ...
                if (!areArrays) {
                  ...
                  if (
                    aCtor !== bCtor &&
                    !(isFunction$1(aCtor) && aCtor instanceof aCtor && isFunction$1(bCtor) && bCtor instanceof bCtor) &&
                    'constructor' in a &&
                    'constructor' in b
                  ) {
                    return false;
      ...
      '/../../../jshint/src/jshint.js': [
        function (_dereq_, module, exports) {
          ...
          var JSHINT = (function () {
            ...
            function isEndOfExpr(context, curr, next) {
              ...
              if (next.infix === curr.infix || (curr.id === 'yield' && curr.rbp < next.rbp)) {
            ...
            function statement(context) {
              ...
              if (
                ...
                !(r.type === '(punctuator)' && r.left && r.left.identifier && r.left.value === 'function')
              ) {
            ...
            reserve('this', function () {
              if (
                ...
                ((state.funct['(statement)'] && state.funct['(name)'].charAt(0) > 'Z') || state.funct['(global)'])
              ) {
                warning('W040', this);
              }
            ...
            relation('==', function (context, left, right) {
              var eqnull =
                state.option.eqnull && ((left && left.value) === 'null' || (right && right.value) === 'null');
              ...
              if (ret.id === ',') {
                ...
                if (!isNecessary) {
                  ...
                  isNecessary =
                    ...
                    (ret.type === '(number)' && checkPunctuator(pn, '.') && /^\d+$/.test(ret.value)) ||
            ...
            function doTemplateLiteral(context, leftOrRbp) {
              ...
              function end() {
                ...
                var complete =
                  state.tokens.next.template && state.tokens.next.tail && state.tokens.next.context === ctx;
                if (complete) advance();
            ...
            function destructuringPatternMatch(tokens, value) {
              ...
              _.zip(tokens, Array.isArray(first) ? first : [first]).forEach(function (val) {
                ...
                else if (token && token.first && !value) warning('W080', token.first, token.first.value);
              });
            }
            ...
            blockstmt('for', function (context) {
              ...
              if (state.tokens.next.id === 'var') {
                ...
                (state.tokens.next.id === 'let' &&
                  ((afterNext.identifier && afterNext.id !== 'in') || checkPunctuators(afterNext, ['{', '['])))
              ) {
                ...
                while (
                  ...
                  if (checkPunctuators(state.tokens.next, ['{', '['])) {
                    destructuringPattern(headContext, { assignment: true }).forEach(function (elem) {
        ...
        },
        {
          ...
          underscore: '/../../../jshint/node_modules/underscore/underscore-umd.js',
        },
      ],
      '/../../../jshint/src/lex.js': [
        function (_dereq_, module, exports) {
          ...
          Lexer.prototype = {
            ...
            scanIdentifier: function (checks) {
              ...
              var readUnicodeEscapeSequence = function () {
                ...
                var sequence =
                  this.peek(index + 1) + this.peek(index + 2) + this.peek(index + 3) + this.peek(index + 4);
                var code;
            ...
            scanRegExp: function (checks) {
              ...
              while (index < length) {
                ...
                if (char === '[') {
                  ...
                  if (this.peek(index + 1) === '?' && (this.peek(index + 2) === '=' || this.peek(index + 2) === '!')) {
                    isQuantifiable = true;
                  }
                } else if (char === ')') {
                  if (isQuantifiable) {
            ...
            next: function (checks) {
              ...
              var match =
                this.scanComments(checks) || this.scanStringLiteral(checks) || this.scanTemplateLiteral(checks);
            ...
            nextLine: function (checks) {
              ...
              if (!this.ignoringLinterErrors && state.option.maxlen && state.option.maxlen < this.input.length) {
                var inComment =
                  this.inComment || startsWith.call(inputTrimmed, '//') || startsWith.call(inputTrimmed, '/*');
        ...
        },
        {
          ...
          '../data/non-ascii-identifier-part-only.js': '/../../../jshint/data/non-ascii-identifier-part-only.js',
          '../data/non-ascii-identifier-start.js': '/../../../jshint/data/non-ascii-identifier-start.js',
          './reg.js': '/../../../jshint/src/reg.js',
          './state.js': '/../../../jshint/src/state.js',
          './validate-unicode-escape-sequence': '/../../../jshint/src/validate-unicode-escape-sequence.js',
          events: '/node_modules/events/events.js',
          underscore: '/../../../jshint/node_modules/underscore/underscore-umd.js',
        },
      ],
      '/../../../jshint/src/messages.js': [
        function (_dereq_, module, exports) {
          ...
          var warnings = {
            ...
            W045:
              'Value described by numeric literal cannot be accurately ' + "represented with a number value: '{a}'.",
            ...
            var scopeManagerInst = {
              ...
              addbinding: function (bindingName, opts) {
                ...
                var ishoisted =
                  ...
                  type === 'import';
                var isexported =
                  (isblockscoped ? _current : _currentFunctBody)['(type)'] === 'global' && _.has(exported, bindingName);
                _checkOuterShadow(bindingName, token);
                ...
                if (isblockscoped) {
                  ...
                  scopeManagerInst.block.add(bindingName, type, token, !isexported, opts.initialized);
                } else {
              ...
              block: {
                ...
                use: function (bindingName, token) {
                  ...
                  if (
                    ...
                    if (!scopeManagerInst.funct.has(bindingName, { excludeParams: true, onlyBlockscoped: true })) {
      ...
      '/node_modules/util/support/isBufferBrowser.js': [
        function (_dereq_, module, exports) {
          arguments[4]['/node_modules/assert/node_modules/util/support/isBufferBrowser.js'][0].apply(
            exports,
            arguments,
          );
        },
