      ...
      this.$rules = {
        start: [
          ...
          },
          {
            ...
            push: [
              { token: 'comment.documentation.heredoc', regex: '\\s*"""', next: 'pop' },
          ...
          },
          {
            ...
            regex: ":'",
            push: [
              { token: 'punctuation.definition.constant.elixir', regex: "'", next: 'pop' },
              { include: '#interpolated_elixir' },
              { include: '#escaped_char' },
          ...
          },
          {
            ...
            originalRegex: "(?>''')",
            push: [
              { token: 'punctuation.definition.string.end.elixir', regex: "^\\s*'''", next: 'pop' },
              { include: '#interpolated_elixir' },
              { include: '#escaped_char' },
          ...
          },
          {
            ...
            regex: "'",
            push: [
              { token: 'punctuation.definition.string.end.elixir', regex: "'", next: 'pop' },
              { include: '#interpolated_elixir' },
              { include: '#escaped_char' },
          ...
          },
          {
            ...
            regex: '~[a-z]\\{',
            push: [
              { token: 'punctuation.definition.string.end.elixir', regex: '\\}[a-z]*', next: 'pop' },
              { include: '#interpolated_elixir' },
              { include: '#escaped_char' },
          ...
          },
          {
            ...
            regex: '~[a-z][^\\w]',
            push: [
              { token: 'punctuation.definition.string.end.elixir', regex: '[^\\w][a-z]*', next: 'pop' },
              { include: '#interpolated_elixir' },
              { include: '#escaped_char' },
              { include: '#escaped_char' },
              { defaultToken: 'string.interpolated.elixir' },
        ...
        '#interpolated_elixir': [
          { token: ['source.elixir.embedded.source', 'source.elixir.embedded.source.empty'], regex: '(#\\{)(\\})' },
          {
            todo: {
              token: 'punctuation.section.embedded.elixir',
              regex: '#\\{',
              push: [
                { token: 'punctuation.section.embedded.elixir', regex: '\\}', next: 'pop' },
        ...
        '#nest_curly_and_self': [
          {
            ...
            regex: '\\{',
            push: [
              { token: 'punctuation.section.scope.elixir', regex: '\\}', next: 'pop' },
              { include: '#nest_curly_and_self' },
            ],
          },
          { include: '$self' },
        ...
        '#regex_sub': [
          ...
          },
          {
            ...
            regex: '\\[(?:\\^?\\])?',
            push: [
              { token: 'punctuation.definition.character-class.elixir', regex: '\\]', next: 'pop' },
              { include: '#escaped_char' },
          ...
          },
          {
            ...
            regex: '\\(',
            push: [
              { token: 'punctuation.definition.group.elixir', regex: '\\)', next: 'pop' },
              { include: '#regex_sub' },
...
ace.define(
  ...
  ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/html_highlight_rules', 'ace/mode/elixir_highlight_rules'],
  function (require, exports, module) {
    'use strict';
    var oop = require('../lib/oop');
