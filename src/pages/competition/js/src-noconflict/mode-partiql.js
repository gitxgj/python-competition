...
ace.define(
  ...
  ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules', 'ace/mode/ion_highlight_rules'],
  function (require, exports, module) {
    /*
  THIS FILE WAS GENERATED BY 'ligand' USING 'mode_highlight_rules.js'
*/
    ...
    var PartiqlHighlightRules = function () {
      ...
      this.embedRules(IonHighlightRules, 'ion-', [
        { token: 'punctuation.definition.ion.end.partiql', regex: '`', next: 'start' },
      ]);
      this.normalizeRules();
    };
