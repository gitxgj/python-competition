ace.define(
  ...
  function (require, exports, module) {
    ...
    var MELHighlightRules = function () {
      this.$rules = {
        start: [
          { caseInsensitive: true, token: 'storage.type.mel', regex: '\\b(matrix|string|vector|float|int|void)\\b' },
          {
          ...
          { caseInsensitive: true, token: 'constant.language.mel', regex: '\\b(null|undefined)\\b' },
          {
          ...
          { caseInsensitive: true, token: 'keyword.operator.mel', regex: '\\b(instanceof)\\b' },
