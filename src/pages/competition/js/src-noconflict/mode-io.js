ace.define(
  ...
  function (require, exports, module) {
      ...
      this.$rules = {
        start: [
          ...
          },
          {
            ...
            regex: '/\\*',
            push: [
              { token: 'punctuation.definition.comment.io', regex: '\\*/', next: 'pop' },
          ...
          { token: 'support.function.open-gl.io', regex: '\\bgl(?:u|ut)?[A-Z]\\w+\\b' },
          {
            ...
            regex: '"""',
            push: [
              { token: 'punctuation.definition.string.end.io', regex: '"""', next: 'pop' },
    ...
    IoHighlightRules.metaData = { fileTypes: ['io'], keyEquivalent: '^~I', name: 'Io', scopeName: 'source.io' };
