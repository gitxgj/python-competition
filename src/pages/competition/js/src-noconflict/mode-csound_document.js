...
ace.define(
  ...
  ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/csound_preprocessor_highlight_rules'],
  function (require, exports, module) {
    'use strict';
    var oop = require('../lib/oop');
      ...
      start.push(
        ...
        },
        {
          ...
          onMatch: function (value, currentState, stack, line) {
            ...
            else if (deprecatedOpcodes.hasOwnProperty(name)) type = 'invalid.deprecated.csound';
            if (type) {
              if (tokens[2]) {
                return [
...
ace.define(
  ...
  ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/csound_document_highlight_rules'],
  function (require, exports, module) {
    'use strict';
    var oop = require('../lib/oop');
