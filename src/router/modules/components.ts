...
export default [
...

  {
    ...
    name: 'community',
    component: Layout,
    redirect: '/community/base',
    meta: { title: '社区交流', icon: ViewModuleIcon },
    children: [
      {
        path: 'NationalSort',
        name: 'NationalSort',
        component: () => import('@/pages/community/national-sort.vue'),
        meta: { title: '全国排名' },
      },
      {
        path: 'Forum',
  ...
  },
  {
    ...
    name: 'competition',
    component: Layout,
    redirect: '/competition/base',
    meta: { title: '挑战赛', icon: ViewModuleIcon },
    children: [
      {
        path: 'PythonCompile',
        name: 'PythonCompile',
        component: () => import('@/pages/competition/python-compile.vue'),
        meta: { title: 'Demo编译器' },
      },
      {
        path: 'EasyCompetition',
        name: 'EasyCompetition',
        component: () => import('@/pages/competition/easy-competition.vue'),
        meta: { title: '入门&菜鸟赛' },
      },
      {
        path: 'Brython',
        name: 'Brython',
        component: () => import('@/pages/competition/brython.vue'),
        meta: { title: '程序员&终极赛' },
      },
      {
        path: 'Attend',
        name: 'Attend',
        component: () => import('@/pages/competition/attend.vue'),
        meta: { title: '参加赛事' },
      },
      {
        path: 'CreateCompetition',
        name: 'CreateCompetition',
        component: () => import('@/pages/competition/create-competition.vue'),
        meta: { title: '开启比赛' },
      },
      {
        path: 'My',
        name: 'My',
        component: () => import('@/pages/competition/my-competition.vue'),
        meta: { title: '我的比赛记录' },
      },
      {
        path: 'Review',
